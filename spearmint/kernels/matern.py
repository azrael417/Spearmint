...
import numpy as np
import kernels.kernel_utils as ku
...
class Matern52(AbstractKernel):
    ...
    def cross_cov(self, inputs_1, inputs_2):
        r2  = np.abs(ku.dist2(self.ls.value, inputs_1, inputs_2))
        r   = np.sqrt(r2)
    ...
    def cross_cov_grad_data(self, inputs_1, inputs_2):
        ...
        return grad_r2[:,:,np.newaxis] * ku.grad_dist2(self.ls.value, inputs_1, inputs_2)
